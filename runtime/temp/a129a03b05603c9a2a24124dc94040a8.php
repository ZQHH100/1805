<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:93:"D:\phpstudy_pro\WWW\aliyun_1805\public/../application/admin\view\category\categoryupdate.html";i:1536737672;s:76:"D:\phpstudy_pro\WWW\aliyun_1805\public/../application/admin\view\layout.html";i:1538028866;s:81:"D:\phpstudy_pro\WWW\aliyun_1805\public/../application/admin\view\public\head.html";i:1541725994;s:81:"D:\phpstudy_pro\WWW\aliyun_1805\public/../application/admin\view\public\left.html";i:1540871306;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-side layui-bg-black">
    ...
    <input type="hidden" id="cate_id" value="<?php echo $data['cate_id']; ?>" name="cate_id">
    <div class="layui-form-item">
        <label class="layui-form-label">分类名称</label>
        <div class="layui-input-block">
            <input type="text" name="cate_name" value="<?php echo $data['cate_name']; ?>" lay-verify="required|username" autocomplete="off" placeholder="请输入名称" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="pid">
                ...
                <?php if(is_array($sel) || $sel instanceof \think\Collection || $sel instanceof \think\Paginator): $i = 0; $__LIST__ = $sel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
...
<script>
    layui.use(['form', 'layer'], function(){
        ...
        form.on('submit(*)',function(data){
            $.post(
                    "<?php echo url('Category/cateUpdateDo'); ?>",
                    data.field,
                    function(msg){
                        console.log(msg);
                        layer.msg(msg.font,{icon:msg.code});
