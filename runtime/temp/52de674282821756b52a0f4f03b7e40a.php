<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"D:\phpstudy_pro\WWW\aliyun_1805\public/../application/admin\view\category\categorylist.html";i:1590591993;s:76:"D:\phpstudy_pro\WWW\aliyun_1805\public/../application/admin\view\layout.html";i:1538028866;s:81:"D:\phpstudy_pro\WWW\aliyun_1805\public/../application/admin\view\public\head.html";i:1541725994;s:81:"D:\phpstudy_pro\WWW\aliyun_1805\public/../application/admin\view\public\left.html";i:1540871306;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<table class="layui-table">
    ...
    <tbody>
            ...
            <tr class="showHide" pid="<?php echo $v['pid']; ?>"  cate_id="<?php echo $v['cate_id']; ?>" style="display:none;">
                ...
                <td><a class="del" href="#" cate_id="<?php echo $v['cate_id']; ?>">删除</a>&nbsp;&nbsp;||&nbsp;&nbsp;<a href="<?php echo url('Category/categoryUpdate'); ?>?cate_id=<?php echo $v['cate_id']; ?>">修改</a></td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
    </tbody>
</table>
